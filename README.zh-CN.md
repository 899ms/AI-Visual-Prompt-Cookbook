...
<p align="center">
  <img alt="风格数量" src="https://img.shields.io/badge/styles-141-ff5a7a?style=flat-square">
  <img alt="预览图" src="https://img.shields.io/badge/previews-282-4cc9f0?style=flat-square">
...
先看这 6 个风格。每个风格都保持轻量：一个 JSON 加两张预览图。完整 141 个风格见下面的 [All Styles](#all-styles) 画廊。
...
<p><a href="styles/annotated-absence/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/annotated-absence.md">复制提示词</a> · <a href="styles/annotated-absence">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/ink-body-manifesto/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/ink-body-manifesto.md">复制提示词</a> · <a href="styles/ink-body-manifesto">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/memory-fragment-portrait/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/memory-fragment-portrait.md">复制提示词</a> · <a href="styles/memory-fragment-portrait">目录</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/portrait-as-terrain/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/portrait-as-terrain.md">复制提示词</a> · <a href="styles/portrait-as-terrain">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/acid-burst-motion-type/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/acid-burst-motion-type.md">复制提示词</a> · <a href="styles/acid-burst-motion-type">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/cream-megatype-impact-editorial/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/cream-megatype-impact-editorial.md">复制提示词</a> · <a href="styles/cream-megatype-impact-editorial">目录</a></p>
</td>
</tr>
</table>
