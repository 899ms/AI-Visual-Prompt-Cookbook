...
<p align="center">
  <img alt="风格数量" src="https://img.shields.io/badge/styles-126-ff5a7a?style=flat-square">
  <img alt="预览图" src="https://img.shields.io/badge/previews-252-4cc9f0?style=flat-square">
...
先看这 6 个风格。每个风格都保持轻量：一个 JSON 加两张预览图。完整 126 个风格见下面的 [All Styles](#all-styles) 画廊。
...
<p><a href="styles/motorsport-technical-editorial/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/motorsport-technical-editorial.md">复制提示词</a> · <a href="styles/motorsport-technical-editorial">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/split-ink-monumental-editorial/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/split-ink-monumental-editorial.md">复制提示词</a> · <a href="styles/split-ink-monumental-editorial">目录</a></p>
</td>
<td width="33%" valign="top">
