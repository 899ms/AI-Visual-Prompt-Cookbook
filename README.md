...
Six visual systems to start with. Every style ships as one JSON plus two preview images. Browse the complete set of 130 in the [All Styles](#all-styles) gallery below.
...
<p><a href="styles/color-pop-interlocked-marker-type/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/color-pop-interlocked-marker-type.md">Copy Prompt</a> · <a href="styles/color-pop-interlocked-marker-type">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/grainy-envelope-flyer-collage/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/grainy-envelope-flyer-collage.md">Copy Prompt</a> · <a href="styles/grainy-envelope-flyer-collage">Folder</a></p>
</td>
<td width="33%" valign="top">
