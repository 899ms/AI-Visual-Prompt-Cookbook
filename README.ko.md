...
이 6개 스타일로 시작하면 라이브러리의 범위를 빠르게 이해할 수 있습니다. 모든 스타일은 JSON 하나와 미리보기 이미지 두 장으로 구성됩니다. 전체 137개는 아래 [All Styles](#all-styles) 갤러리에서 볼 수 있습니다.
...
<p><a href="styles/duotone-step-window-editorial/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/duotone-step-window-editorial.md">프롬프트 복사</a> · <a href="styles/duotone-step-window-editorial">폴더</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/halftone-chroma-fragment-editorial/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/halftone-chroma-fragment-editorial.md">프롬프트 복사</a> · <a href="styles/halftone-chroma-fragment-editorial">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/neon-strip-low-angle-campaign/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/neon-strip-low-angle-campaign.md">프롬프트 복사</a> · <a href="styles/neon-strip-low-angle-campaign">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/op-stripe-card-editorial/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/op-stripe-card-editorial.md">프롬프트 복사</a> · <a href="styles/op-stripe-card-editorial">폴더</a></p>
</td>
</tr>
</table>
