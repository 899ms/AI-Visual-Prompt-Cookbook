...
まずこの 6 つを見ると、ライブラリの幅がわかります。すべてのスタイルは 1 つの JSON と 2 枚のプレビュー画像で構成されています。130 種すべては下の [All Styles](#all-styles) ギャラリーで確認できます。
...
<p><a href="styles/color-pop-interlocked-marker-type/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/color-pop-interlocked-marker-type.md">プロンプトをコピー</a> · <a href="styles/color-pop-interlocked-marker-type">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/grainy-envelope-flyer-collage/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/grainy-envelope-flyer-collage.md">プロンプトをコピー</a> · <a href="styles/grainy-envelope-flyer-collage">フォルダ</a></p>
</td>
<td width="33%" valign="top">
