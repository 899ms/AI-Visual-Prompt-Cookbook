...
まずこの 6 つを見ると、ライブラリの幅がわかります。すべてのスタイルは 1 つの JSON と 2 枚のプレビュー画像で構成されています。137 種すべては下の [All Styles](#all-styles) ギャラリーで確認できます。
...
<p><a href="styles/duotone-step-window-editorial/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/duotone-step-window-editorial.md">プロンプトをコピー</a> · <a href="styles/duotone-step-window-editorial">フォルダ</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/halftone-chroma-fragment-editorial/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/halftone-chroma-fragment-editorial.md">プロンプトをコピー</a> · <a href="styles/halftone-chroma-fragment-editorial">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/neon-strip-low-angle-campaign/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/neon-strip-low-angle-campaign.md">プロンプトをコピー</a> · <a href="styles/neon-strip-low-angle-campaign">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/op-stripe-card-editorial/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/op-stripe-card-editorial.md">プロンプトをコピー</a> · <a href="styles/op-stripe-card-editorial">フォルダ</a></p>
</td>
</tr>
</table>
