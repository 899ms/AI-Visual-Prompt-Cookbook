...
まずこの 6 つを見ると、ライブラリの幅がわかります。すべてのスタイルは 1 つの JSON と 2 枚のプレビュー画像で構成されています。116 種すべては下の [All Styles](#all-styles) ギャラリーで確認できます。
...
<p><a href="styles/signal-red-petal-profile-editorial-cover/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/signal-red-petal-profile-editorial-cover.md">プロンプトをコピー</a> · <a href="styles/signal-red-petal-profile-editorial-cover">フォルダ</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/cobalt-pop-cutout-editorial/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/cobalt-pop-cutout-editorial.md">プロンプトをコピー</a> · <a href="styles/cobalt-pop-cutout-editorial">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/crimson-noir-newsprint-editorial-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/crimson-noir-newsprint-editorial-style.md">プロンプトをコピー</a> · <a href="styles/crimson-noir-newsprint-editorial-style">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/electric-cobalt-motion-type-poster-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/electric-cobalt-motion-type-poster-style.md">プロンプトをコピー</a> · <a href="styles/electric-cobalt-motion-type-poster-style">フォルダ</a></p>
</td>
</tr>
</table>
