...
まずこの 6 つを見ると、ライブラリの幅がわかります。すべてのスタイルは 1 つの JSON と 2 枚のプレビュー画像で構成されています。141 種すべては下の [All Styles](#all-styles) ギャラリーで確認できます。
...
<p><a href="styles/annotated-absence/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/annotated-absence.md">プロンプトをコピー</a> · <a href="styles/annotated-absence">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/ink-body-manifesto/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/ink-body-manifesto.md">プロンプトをコピー</a> · <a href="styles/ink-body-manifesto">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/memory-fragment-portrait/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/memory-fragment-portrait.md">プロンプトをコピー</a> · <a href="styles/memory-fragment-portrait">フォルダ</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/portrait-as-terrain/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/portrait-as-terrain.md">プロンプトをコピー</a> · <a href="styles/portrait-as-terrain">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/acid-burst-motion-type/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/acid-burst-motion-type.md">プロンプトをコピー</a> · <a href="styles/acid-burst-motion-type">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/cream-megatype-impact-editorial/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/cream-megatype-impact-editorial.md">プロンプトをコピー</a> · <a href="styles/cream-megatype-impact-editorial">フォルダ</a></p>
</td>
</tr>
</table>
