...
<p align="center">
  <img alt="風格數量" src="https://img.shields.io/badge/styles-137-ff5a7a?style=flat-square">
  <img alt="預覽圖" src="https://img.shields.io/badge/previews-274-4cc9f0?style=flat-square">
...
先看這 6 個風格。每個風格都保持輕量：一個 JSON 加兩張預覽圖。完整 137 個風格見下面的 [All Styles](#all-styles) 畫廊。
...
<p><a href="styles/duotone-step-window-editorial/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/duotone-step-window-editorial.md">複製提示詞</a> · <a href="styles/duotone-step-window-editorial">目錄</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/halftone-chroma-fragment-editorial/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/halftone-chroma-fragment-editorial.md">複製提示詞</a> · <a href="styles/halftone-chroma-fragment-editorial">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/neon-strip-low-angle-campaign/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/neon-strip-low-angle-campaign.md">複製提示詞</a> · <a href="styles/neon-strip-low-angle-campaign">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/op-stripe-card-editorial/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/op-stripe-card-editorial.md">複製提示詞</a> · <a href="styles/op-stripe-card-editorial">目錄</a></p>
</td>
</tr>
</table>
