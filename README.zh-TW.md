...
<p align="center">
  <img alt="風格數量" src="https://img.shields.io/badge/styles-141-ff5a7a?style=flat-square">
  <img alt="預覽圖" src="https://img.shields.io/badge/previews-282-4cc9f0?style=flat-square">
...
先看這 6 個風格。每個風格都保持輕量：一個 JSON 加兩張預覽圖。完整 141 個風格見下面的 [All Styles](#all-styles) 畫廊。
...
<p><a href="styles/annotated-absence/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/annotated-absence.md">複製提示詞</a> · <a href="styles/annotated-absence">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/ink-body-manifesto/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/ink-body-manifesto.md">複製提示詞</a> · <a href="styles/ink-body-manifesto">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/memory-fragment-portrait/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/memory-fragment-portrait.md">複製提示詞</a> · <a href="styles/memory-fragment-portrait">目錄</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/portrait-as-terrain/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/portrait-as-terrain.md">複製提示詞</a> · <a href="styles/portrait-as-terrain">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/acid-burst-motion-type/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/acid-burst-motion-type.md">複製提示詞</a> · <a href="styles/acid-burst-motion-type">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/cream-megatype-impact-editorial/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/cream-megatype-impact-editorial.md">複製提示詞</a> · <a href="styles/cream-megatype-impact-editorial">目錄</a></p>
</td>
</tr>
</table>
