...
<p align="center">
  <img alt="風格數量" src="https://img.shields.io/badge/styles-126-ff5a7a?style=flat-square">
  <img alt="預覽圖" src="https://img.shields.io/badge/previews-252-4cc9f0?style=flat-square">
...
先看這 6 個風格。每個風格都保持輕量：一個 JSON 加兩張預覽圖。完整 126 個風格見下面的 [All Styles](#all-styles) 畫廊。
...
<p><a href="styles/motorsport-technical-editorial/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/motorsport-technical-editorial.md">複製提示詞</a> · <a href="styles/motorsport-technical-editorial">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/split-ink-monumental-editorial/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/split-ink-monumental-editorial.md">複製提示詞</a> · <a href="styles/split-ink-monumental-editorial">目錄</a></p>
</td>
<td width="33%" valign="top">
